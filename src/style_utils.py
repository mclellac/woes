...
def _get_linux_font_preferences(
    ...
    """Helper to get font preferences from GNOME settings on Linux."""
    font_family = None
    ...
    try:
        ...
        gnome_a11y_settings.get_boolean(
            HIGH_CONTRAST_KEY
...
def _get_app_font_scaling(app_settings: Gio.Settings) -> float:
    """Helper to get app-specific font scaling percentage."""
...
def apply_font_size(
        settings: Gio.Settings, font_scale_percentage_str: str
